...
export const OpenIn = (props: OpenInProps) => <DropdownMenu {...props} />;
...
export const OpenInChatGPT = ({ query, ...props }: OpenInV0Props) => (
...
export const OpenInClaude = ({ query, ...props }: OpenInClaudeProps) => (
  <DropdownMenuItem asChild {...props}>
    <a
      className="flex items-center gap-2"
...
export const OpenInT3 = ({ query, ...props }: OpenInT3Props) => (
  <DropdownMenuItem asChild {...props}>
    <a
      className="flex items-center gap-2"
...
export const OpenInScira = ({ query, ...props }: OpenInSciraProps) => (
  <DropdownMenuItem asChild {...props}>
    <a
      className="flex items-center gap-2"
...
export const OpenInv0 = ({ query, ...props }: OpenInv0Props) => (
  <DropdownMenuItem asChild {...props}>
    <a
      className="flex items-center gap-2"

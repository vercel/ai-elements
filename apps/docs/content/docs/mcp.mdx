  ...
  "mcpServers": {
    "ai-elements": {
      ...
      "args": [
        "-y",
        "mcp-remote",
        "https://ai-sdk.dev/elements/api/registry/api/mcp"
      ]
    }
  }
}
...
`claude mcp add --transport http ai-elements https://ai-sdk.dev/elements/api/registry/api/mcp`
...
```json title=".cursor/mcp.json"
{
  "mcpServers": {
    "ai-elements": {
      "command": "npx",
      "args": ["-y", "mcp-remote", "https://ai-sdk.dev/elements/api/registry/api/mcp"]
    },
    "github": {
      "command": "npx",

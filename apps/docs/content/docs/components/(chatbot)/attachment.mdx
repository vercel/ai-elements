...
path: elements/components/attachment
---
...
<Preview path="attachment" />

## Installation

<ElementsInstaller path="attachment" />
...
<Preview path="attachment-inline" />

### List Variant

Best for file lists with full metadata display.

<Preview path="attachment-list" />
...
```tsx
import { getMediaCategory } from '@/components/ai-elements/attachment';
...
```tsx
import { getAttachmentLabel } from '@/components/ai-elements/attachment';
